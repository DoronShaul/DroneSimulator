...
public class SimulationWindow {
	...
	private void initialize() {
		...
		returnBtn.addActionListener(new ActionListener()
		{
			  public void actionPerformed(ActionEvent e)
			  {
				  ...
				  algo2.speedDown();
				  algo2.spinBy(180, true, new Func() {
						@Override
						public void method() {
							algo2.speedUp();
						}
	...
	public void main() {
		...
		Map map = new Map("C:\\Users\\doron\\Desktop\\DroneSimulator-master\\Maps\\p1" + map_num + ".png",startPoints[map_num-1]);
		
		//algo1 = new AutoAlgo1(map);
		algo2 = new AutoAlgo2(map);
		
		Painter painter = new Painter(algo2);
		...
		updatesCPU.addFunction(algo2.drone::update);
		updatesCPU.play();
	...
	public void updateInfo(int deltaTime) {
		info_label.setText(algo2.drone.getInfoHTML());
		info_label2.setText("<html>" + String.valueOf(algo2.counter) + " <BR>isRisky:" + String.valueOf(algo2.is_risky) + 
				"<BR>" + String.valueOf(algo2.risky_dis) + "</html>");
